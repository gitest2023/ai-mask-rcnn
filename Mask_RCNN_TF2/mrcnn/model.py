...
## - Way 1: Using tf.keras.optimizers.legacy.SGD - instead of tf.keras.optimizers.SGD              ##
## - Way 2: Importing statement is changed from import tensorflow.keras as keras to 'import keras' ##
#####################################################################################################
# import keras
import tensorflow.keras as keras
...
def mold_image(images, config):
    ...
    return np.asarray(images).astype(np.float32) - config.MEAN_PIXEL
